<?php
    ...
    $jumlahData = count(query("SELECT * FROM file"));
    ...
    $file = query("SELECT * FROM file WHERE id_author = '$id_author' LIMIT $awalData, $jumlahDataPerHalaman");
...
<html lang="en">
    <head>
        ...
        <title>Tahap Dua - SIMSEMPI</title>
    ...
    <body class="bg-custom" style="background-image: url('assets/img/unesa.jpg');">
        ...
        <div class="container">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-uppercase fw-bold">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="tahap2.php">Tahap 2</a>
                            </li>
                        </ul>
            ...
            <h1 class="text-center mb-4 mt-4 pb-4 pt-4 text-light" data-aos="zoom-in"><u>Tahap 2</u> : Sistem Monitoring Seminar Praktik Industri</h1>
            <div class="row mt-4">
            ...
            <div class="table-responsive">
                <table class="table table-secondary table-hover" border="1" cellpadding="10" cellspacing="0" data-aos="zoom-in" data-aos-duration="1000">
                    <thead>
                        <tr>
                            <th colspan="2" class="text-center"><i>Silahkan download undangan, isi sesuai dengan keterangan yang ada. Jangan merubah format undangan.</i></th>
                        </tr>
                        <tr class="d-flex text-center align-self-center">
                            <th width="120px">Jadwal Sidang</th>
                            <th width="120px">Waktu Sidang</th>
                            <th width="175px">Dosen Penguji</th>
                            <th width="140px">Laporan</th>
                            <th width="140px">Nilai PI Instansi</th>
                            <th width="140px">Lembar Pengesahan</th>
                            <th width="98px">Tahapan</th>
                    ...
                    <tbody>
                        ...
                        <tr class="d-flex text-center">
                            <td width="120px"><?= $row["jadwal"]; ?></td>
                            <td width="120px"><?= $row["pukul"]; ?></td>
                            <td width="175px"><?= $row["uji"]; ?></td>
                            <td width="140px"><?= $row["laporan"]; ?></td>
                            <td width="140px"><?= $row["nilai"]; ?></td>
                            <td width="140px"><?= $row["pengesahan"]; ?></td>
                            <td width="98px"><?= $row["tahapan"]; ?></td>
                            <td width="80px">
                                <a href="ubah_tahap2.php?id=<?= $row["id"]; ?>"><i class="bi bi-pencil-square"></i></a>
                                <a href="hapus_tahap2.php?id=<?= $row["id"]; ?>" id="hapus" onclick= "return confirm('Apakah yakin ingin menghapus data, <?= $row["tahapan"];?>?');"><i class="bi bi-trash"></i></a>
                            </td>
                            <td width="100px">
                                <a href="download.php?file=pdf/undangansempi.pdf" target="_new"><i class="bi-file-post"></i>Download File</a>
                            </td>
                        </tr>
                    </tbody>
                    <?php endforeach; ?>
