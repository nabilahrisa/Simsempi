...
<html lang="en">
    <head>
        ...
        <title>Profil Mahasiswa - SIMSEMPI</title>
    ...
    <body class="bg-custom" style="background-image: url('assets/img/unesa.jpg');">
        <div class="container">
            ...
            <h1 class="text-center mb-4 mt-4 pb-4 pt-4 text-primary" data-aos="zoom-in">Profil Mahasiswa</h1>
            <table class="table table-responsive table-light table-hover" border="1" cellpadding="10" cellspacing="0" data-aos="zoom-in" data-aos-duration="1000">
                <thead>
                    <tr>
                        <th colspan="2" class="text-center">Pastikan Data Profilmu Benar</th>
                    </tr>
                </thead>
                <tbody>
                <?php foreach($result as $row) :?>
                    ...
                    <tr>
                        <td>Edit</td>
                        <td>: <a href="ubahprofile.php?id=<?= $row["id"]; ?>"><button class="btn btn-outline-dark"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</button></a></td>
                    </tr>
                </tbody>
            <?php endforeach; ?>
            </table>
