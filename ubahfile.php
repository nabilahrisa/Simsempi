<?php
    ...
    $id = $_GET["id"];
    $mhs = query("SELECT * FROM file WHERE id = $id") [0];
                ...
                <div class="col-md-5">
                    <h1 class="text-center text-primary mb-4 mt-4 pt-4 pb-2" data-aos="zoom-in" data-aos-duration="1000">Edit data</h1>
                        <form class="row text-light justify-content-md-center g-3 mb-4 pb-4" action="" method = "post" enctype="multipart/form-data" data-aos="zoom-in" data-aos-duration="500">
                            ...
                            <input type="hidden" name="suratLama" value="<?= $mhs["surat"]; ?>">
                            <input type="hidden" name="nilaiLama" value="<?= $mhs["nilai"]; ?>">
                            <input type="hidden" name="lembarLama" value="<?= $mhs["lembar"]; ?>">
                            <input type="hidden" name="proposalLama" value="<?= $mhs["proposal"]; ?>">
                            <div class="col-md-12">
                                <label class="form-label" for="surat">Surat Permohonan Fakultas:  </label> <br>
                                <input class="form-control" type="file" name="surat" id="surat" value="<?= $mhs ["surat"]; ?>">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label" for="proposal">Surat Permohonan Fakultas:  </label> <br>
                                <input class="form-control" type="file" name="proposal" id="proposal" value="<?= $mhs ["proposal"]; ?>">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label" for="nilai">Surat Permohonan Fakultas:  </label> <br>
                                <input class="form-control" type="file" name="nilai" id="nilai" value="<?= $mhs ["nilai"]; ?>">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label" for="lembar">Surat Permohonan Fakultas:  </label> <br>
                                <input class="form-control" type="file" name="lembar" id="lembar" value="<?= $mhs ["lembar"]; ?>">
                            </div>
                            ...
                            <div class="col">
                                <div class="d-grid">
                                    <a href="file.php" class="btn btn-outline-secondary" tabindex="-1" role="button" aria-disabled="false">Kembali</a>
                                </div>
                            </div>
                            <div class="col">
                                <div class="d-grid">
