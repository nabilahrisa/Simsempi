...
<html lang="en">
    <head>
        ...
        <title>Ubah Data - SIMSEMPI</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-uppercase fw-bold">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="file.php">Profil</a>
                            </li>
                        </ul>
                    ...
                    <h1 class="text-center text-primary mb-4 mt-4 pt-4 pb-2" data-aos="zoom-in" data-aos-duration="1000">Ubah data</h1>
                        <form class="row text-light justify-content-md-center g-3 mb-4 pb-4" action="" method = "post" enctype="multipart/form-data" data-aos="zoom-in" data-aos-duration="500">
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="text" name="dospem" id="dospem" required value="<?= $mhs ["dospem"]; ?>">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label" for="tahap">Tahapan :  </label>    
                                <input class="form-control" type="text" name="tahap" id="tahap" required value="<?= $mhs ["tahap"]; ?>">
                            </div>
                            <div class="col">
                                <div class="d-grid">
                                    <a href="index.php" class="btn btn-secondary" tabindex="-1" role="button" aria-disabled="false">Kembali</a>
                                </div>
                            </div>
                            <div class="col">
                                <div class="d-grid">
