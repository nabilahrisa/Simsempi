<?php
    ...
    //         echo "
    //         <script>
    //             alert('data gagal ditambahkan 1!');
    //             document.location.href = 'halaman_admin.php'
    //         </script>
...
<html lang="en">
    ...
    <meta charset="UTF-8">
        ...
        <title>Tambah User - SIMSEMPI</title>
    ...
    <body class="bg-custom" style="background-image: url('assets/img/unesa.jpg');">
        <div class="container">
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-5">
                    <h1 class="text-center text-primary mb-4 mt-4 pt-4 pb-2" data-aos="zoom-in" data-aos-duration="1000">Tambah User</h1>
                    <form class="row text-light justify-content-md-center g-3 mb-4 pb-4" action="" method = "post" enctype="multipart/form-data" data-aos="zoom-in" data-aos-duration="500">
                        ...
                        <div class="col-md-12">
                            <label class="form-label" for="nim">ID:  </label>    
                        ...
                        <div class="col">
                            <div class="d-grid">
                                <a href="halaman_admin.php" class="btn btn-secondary" tabindex="-1" role="button" aria-disabled="false">Kembali</a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-grid">
