            ...
            <div class="row mt-4">
                ...
                <div class="col text-end" data-aos="fade-left">
                    <form class="d-flex" method="post">
                        ...
                        <button class="btn btn-success" type="submit" name="approve_button">Approve Tahap 1</button>
                    </form>
                </div>
                <div class="col text-end" data-aos="fade-left">
                    <form class="d-flex" method="post">
                        <input class="form-control" id="approve_button" type="hidden" name="keyword">
                        <a href="halamanpi_tahap2.php" class="btn btn-success btn" name="approve_button" tabindex="-1" role="button" aria-disabled="true">Approve Tahap 2</a>
                    </form>
                </div>
                <div class="col text-end" data-aos="fade-left">
                ...
                <table class="table table-secondary table-hover" border="1" cellpadding="10" cellspacing="0" data-aos="zoom-in" data-aos-duration="1000">
                    ...
                    <tbody>
                      <?php foreach($query2 as $row) :?>
                        <tr class="d-flex text-center">
                            <td width="135px"><?= $row["jadwal"]; ?></td>
                            <td width="135px"><?= $row["pukul"]; ?></td>
                            <td width="173px"><?= $row["uji"]; ?></td>
                            <td width="140px"><?= $row["laporan"]; ?></td>
                            <td width="140px"><?= $row["nilai"]; ?></td>
                            <td width="140px"><?= $row["pengesahan"]; ?></td>
                            <td width="135px"><?= $row["tahapan"]; ?></td>
                            <td width="115px"><?php if($row["is_approved"] == true) {
                                echo "Approved";
                            } else {
                                echo "Pending";
                            }; ?></td>
