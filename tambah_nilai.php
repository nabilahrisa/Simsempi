    ...
    if (isset($_POST["submit"])) {
        if (tambahnilai($_POST) > 0) {
            ...
            <script>
                ...
                document.location.href = 'halaman_pi.php'
            </script>
            ";
        }
    }
...
<html lang="en">
    <head>
        ...
        <title>Tambah Nilai - SIMSEMPI</title>
    ...
    <body class="bg-custom" style="background-image: url('assets/img/unesa.jpg');">
        <div class="container">
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-5">
                    <h1 class="text-center text-primary mb-4 mt-4 pt-4 pb-2" data-aos="zoom-in" data-aos-duration="1000">Nilai Sempi</h1>
                    <form class="row text-light justify-content-md-center g-3 mb-4 pb-4" action="" method = "post" enctype="multipart/form-data" data-aos="zoom-in" data-aos-duration="500">
                        ...
                        <div class="col-md-12">
                            <label class="form-label" for="nilai">Nilai Sempi :  </label>    
                            <input class="form-control" type="text" name="nilai" id="nilai" required>
                        </div>
                        <div class="col">
                            <div class="d-grid">
                                <a href="halaman_pi.php" class="btn btn-secondary" tabindex="-1" role="button" aria-disabled="false">Kembali</a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-grid">
