...
<html lang="en">
    ...
    <meta charset="UTF-8">
        ...
        <title>Halaman Admin - SIMSEMPI</title>
    ...
    <body class="bg-custom" style="background-image: url('assets/img/unesa.jpg');">
        <div class="container">
            ...
            <h1 class="text-center mb-4 mt-4 pb-4 pt-4 text-light" data-aos="zoom-in">SISTEM INFORMASI MONITORING SEMINAR PRAKTIK INDUSTRI</h1>
            <div class="row mt-4">
                ...
                <div class="col text-end" data-aos="fade-left">
                    <a href="tambahuser.php" class="btn btn-success btn" tabindex="-1" role="button" aria-disabled="true"><i class="bi bi-person-plus"></i>&nbsp;&nbsp;Tambah User</a>
                </div>
            </div>
            <br>
                ...
                <table class="table table-secondary table-hover" border="1" cellpadding="10" cellspacing="0" data-aos="zoom-in" data-aos-duration="1000">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?= $row["level"]; ?></td>
                            <td>
                                <a href="ubahprofileadmin.php?id=<?= $row["id"]; ?>" class="btn btn-outline-warning"><i class="bi bi-pencil-square"></i></a>
                                <a href="hapusprofile.php?id=<?= $row["id"]; ?>" id="hapus" onclick= "return confirm('Apakah yakin ingin menghapus data ?');"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
                    <?php $i++; ?>
