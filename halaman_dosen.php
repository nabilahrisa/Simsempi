...
<html lang="en">
    ...
    <meta charset="UTF-8">
            ...
            <title>Halaman Dosen- SIMSEMPI</title>
            <!-- Bootstrap -->
    ...
    <body class="bg-custom" style="background-image: url('assets/img/unesa.jpg');">
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-dark">
            ...
            <h1 class="text-center mb-4 mt-4 pb-4 pt-4 text-light" data-aos="zoom-in">SISTEM MONITORING SEMINAR PRAKTIK INDUSTRI</h1>
            <div class="row mt-4">
                <div class="col-md-4 col-sm-4" data-aos="fade-right">
                    <form class="d-flex" method="post">
                        ...
                        <button class="btn btn-primary bi bi-search" type="submit" name="cari">&nbsp;Cari</button>
                    </form>
                </div>
            </div>
            <br>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php foreach($user as $row) :?>
                                ...
                                <td>
                                <a href="halaman_pi.php?id=<?=$row['id']?>" class="btn btn-outline-success">Lihat</a>
                                </td>
                        </tr>
                    </tbody>
                <?php $i++; ?>
