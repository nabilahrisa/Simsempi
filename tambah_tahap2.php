    ...
    <body class="bg-custom" style="background-image: url('assets/img/unesa.jpg');">
        <div class="container">
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-5">
                    <h1 class="text-center text-primary mb-4 mt-4 pt-4 pb-2" data-aos="zoom-in" data-aos-duration="1000">Tahap Dua</h1>
                    <form class="row text-light justify-content-md-center g-3 mb-4 pb-4" action="" method = "post" enctype="multipart/form-data" data-aos="zoom-in" data-aos-duration="500">
                        ...
                        <div class="col-md-12">
                            <label class="form-label" for="jadwal">Jadwal Sidang :</label>
                            <input class="form-control" type="date" name="jadwal" id="jadwal" required>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label" for="pukul">Waktu Sidang :  </label>    
                            <input class="form-control" type="time" name="pukul" id="pukul" required>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label" for="uji">Dosen Penguji :  </label>    
                            <input class="form-control" type="text" name="uji" id="uji" required>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label" for="laporan">Laporan :  </label>    
                            <input class="form-control" type="file" name="laporan" id="laporan" required>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label" for="nilai">Nilai PI Instansi :  </label>    
                            <input class="form-control" type="file" name="nilai" id="nilai" required>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label" for="pengesahan">Lembar Pengesahan :  </label>    
                            <input class="form-control" type="file" name="pengesahan" id="pengesahan" required>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label" for="tahapan">Tahapan :  </label>    
                            <input class="form-control" type="text" name="tahapan" size="100" id="tahapan" required>
                        </div>
                        <div class="col">
                            <div class="d-grid">
                                <a href="tahap2.php" class="btn btn-secondary" tabindex="-1" role="button" aria-disabled="false">Kembali</a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-grid">
