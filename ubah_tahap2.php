<?php
    ...
    $id = $_GET["id"];
    $file = query("SELECT * FROM file WHERE id = $id") [0];
...
<html lang="en">
    <head>
        ...
        <title>Ubah Tahap Dua - SIMSEMPI</title>
                    ...
                    <h1 class="text-center text-primary mb-4 mt-4 pt-4 pb-2" data-aos="zoom-in" data-aos-duration="1000">Ubah data</h1>
                        <form class="row text-light justify-content-md-center g-3 mb-4 pb-4" action="" method = "post" enctype="multipart/form-data" data-aos="zoom-in" data-aos-duration="500">
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="date" name="jadwal" id="jadwal" required value="<?= $file ["jadwal"]; ?>">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label" for="pukul">Waktu Sidang :  </label>    
                                <input class="form-control" type="time" name="pukul" id="pukul" required value="<?= $file ["pukul"]; ?>">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label" for="uji">Dosen Penguji:  </label>    
                                <input class="form-control" type="text" name="uji" id="uji" required value="<?= $file ["uji"]; ?>">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label" for="tahapan">Tahapan :  </label>    
                                <input class="form-control" type="text" name="tahapan" id="tahapan" required value="<?= $file ["tahapan"]; ?>">
                            </div>
                            <div class="col">
                                <div class="d-grid">
                            ...
                            <div class="col">
                                <div class="d-grid">
                                    <button class="btn btn-warning" type="submit" name="submit">Edit Data!</button>
                                </div>
                            </div>
                        </form>
                    </div>
